...
const Products = ({planner, stickers}) => {
    
    const [portalImage, setPortalImage] = useState(null);

    // Obtaining elements from the global context.
    const {handleProduct, cart} = useProducts();
                ...
                <div className="planner-container">
                    ...
                    <div className="planner-info">
                        ...
                        <p>Step into a realm of fantasy and organization with our
                            ...
                            scheduling your weekly grocery run, this planner is your 
                            ultimate companion.
                        </p>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                ultra-high resolution, it&apos;s perfect for 
                                printing on any size paper, from A4 to poster-sized 
                                displays.
                            </li>
                        </ul>
                        ...
                        <div className="purchase-btns">
                            <button onClick={() => {
                                ...
                                handleProduct(plannerPriceId, 1, planner)
                            }}>Add to cart</button>
                        </div>
                            ...
                            <div key={stickerIndex} className="sticker-card">
                                ...
                                <div className="sticker-info">
                                    ...
                                    <button onClick={() => {
                                        ...
                                        handleProduct(stickerPriceId, 1, sticker)
                                    }}>Add to cart</button>
                                </div>
                            </div>
                        )
