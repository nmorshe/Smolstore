This is a mock E-store application built with the use of Next.js, FantaCSS, and connected to a Stripe API.
...
and hooks created through react libraries, as well as logo designs from FontAwesome. Now published on Vercel
